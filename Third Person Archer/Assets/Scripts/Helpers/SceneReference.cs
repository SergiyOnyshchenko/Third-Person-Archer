...
public class SceneReferencePropertyDrawer : PropertyDrawer
{
    ...
    private void DrawSceneInfoGUI(Rect position, BuildUtils.BuildScene buildScene, int sceneControlID)
    {
        ...
        {
            iconContent = EditorGUIUtility.IconContent("d_console.erroricon.sml");
        ...
        {
            iconContent = EditorGUIUtility.IconContent("d_console.infoicon.sml");
        ...
        using (new EditorGUI.DisabledScope(readOnly))
        {
            ...
            iconRect.width = (iconContent.image != null ? iconContent.image.width : 16) + padSize;
