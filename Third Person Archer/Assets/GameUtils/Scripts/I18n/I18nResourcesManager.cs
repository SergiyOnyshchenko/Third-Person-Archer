...
namespace YsoCorp {
    namespace GameUtils {
        ...
        public class I18nResourcesManager : BaseManager {
            ...
            public string GetString(string key, string lang, GameObject debugObject = null) {
                ...
                if (strings != null && strings.ContainsKey(key)) {
                    ...
                    string error = "[YCManager.i18nManager] Couldn't find the " + this.ycManager.dataManager.GetLanguage() + " translation for \"" + key + "\"";
                    if (debugObject != null) {
                        Debug.LogError(error, debugObject);
                    } else {
