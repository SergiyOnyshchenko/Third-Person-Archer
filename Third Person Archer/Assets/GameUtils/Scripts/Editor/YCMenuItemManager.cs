    ...
    namespace GameUtils {
        ...
        public class YCMenuItemManager {
            ...
            static void ImportAmazon() {
                YCUpdatesHandler.UpdatePackage(YCPackageManager.UpdatePackageType.Amazon);
            }

            [MenuItem("GameUtils/Import Package/Firebase", false, 1003)]
            static void ImportFirebase() {
                YCUpdatesHandler.UpdatePackage(YCPackageManager.UpdatePackageType.Firebase);
            }

            [MenuItem("GameUtils/Import Package/Prod Networks", false, 1004)]
            static void ImportProdNetworks() {
                YCUpdatesHandler.UpdatePackage(YCPackageManager.UpdatePackageType.ProdNetworks);
            }

            [MenuItem("GameUtils/Import Package/Rate Popup", false, 1501)]
            static void ImportRatePopup() {
                YCUpdatesHandler.UpdatePackage(YCPackageManager.UpdatePackageType.RatePopup);
            }
