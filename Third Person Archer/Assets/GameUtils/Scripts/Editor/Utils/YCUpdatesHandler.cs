...
namespace YsoCorp {
    namespace GameUtils {
        ...
        public class YCUpdatesHandler {
            ...
            public static void UpdatePackage(YCPackageManager.UpdatePackageType packageType) {
                string folder = YCPackageManager.PACKAGES[packageType].folderPath;
                string fileName = YCPackageManager.PACKAGES[packageType].fileName + ".unitypackage";
                string downloadURL = YCPackageManager.PACKAGES_URL + folder + fileName;
