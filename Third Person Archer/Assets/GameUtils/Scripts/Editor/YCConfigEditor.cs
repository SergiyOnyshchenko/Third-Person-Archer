    ...
    namespace GameUtils {
        ...
        public class YCConfigEditor : Editor {
            ...
            public static void DisplayImportConfigDialog(YCConfig.InfosData infos) {
                ...
                //Updates 
#if AMAZON_APS
                Version amazonWantedVersion = YCPackageManager.PACKAGES[YCPackageManager.UpdatePackageType.Amazon].version;
                ...
                Version firebaseWantedVersion = YCPackageManager.PACKAGES[YCPackageManager.UpdatePackageType.Firebase].version;
