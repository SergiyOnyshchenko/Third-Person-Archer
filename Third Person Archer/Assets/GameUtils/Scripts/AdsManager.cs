...
namespace YsoCorp {
    namespace GameUtils {
        ...
        public class AdsManager : BaseManager {
            ...
            [HideInInspector]
            public BooleanOverride bannerTransparencyOverride {
...
#if !UNITY_EDITOR
            private AmazonAds.AdNetworkInfo _adNetworkInfo = new AmazonAds.AdNetworkInfo(AmazonAds.ApsAdNetwork.MAX);
#endif
#endif
...
#if !UNITY_EDITOR
                    this.rewardedAdRequest = new AmazonAds.APSVideoAdRequest(320, 480, this.GetAmazonRewardedKey(), this._adNetworkInfo);
#endif
...
#if !UNITY_EDITOR
                    this.interstitialAdRequest = new AmazonAds.APSVideoAdRequest(320, 480, this.GetAmazonInterstitialKey(), this._adNetworkInfo);
#endif
...
#if !UNITY_EDITOR
                    this.bannerAdRequest = new AmazonAds.APSBannerAdRequest(320, 50, this.GetAmazonBannerKey(), this._adNetworkInfo);
#endif
                    if (this.bannerAdRequest != null) {
