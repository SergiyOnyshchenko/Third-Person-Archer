    ...
    public class Adjust : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            if (!this.startManually)
            {
                ...
                adjustConfig.setFbAppId("724844596409692");
        ...
        {
            Debug.Log("   --- -- - GRE844IUVBA983>> Attribution callback called!");
            Debug.Log("   --- -- - GRE844IUVBA983>> Tracker token: " + attribution.trackerToken);
            Debug.Log("   --- -- - GRE844IUVBA983>> Tracker name: " + attribution.trackerName);
            Debug.Log("   --- -- - GRE844IUVBA983>> Network: " + attribution.network);
            Debug.Log("   --- -- - GRE844IUVBA983>> Campaign: " + attribution.campaign);
            Debug.Log("   --- -- - GRE844IUVBA983>> Adgroup: " + attribution.adgroup);
            Debug.Log("   --- -- - GRE844IUVBA983>> Creative: " + attribution.creative);
            Debug.Log("   --- -- - GRE844IUVBA983>> Click label: " + attribution.clickLabel);
            Debug.Log("   --- -- - GRE844IUVBA983>> Adid: " + attribution.adid);
        }

        private void EventSuccessCallback(AdjustEventSuccess eventSuccess)
        {
            Debug.Log("   --- -- - GRE844IUVBA983>> Event success callback called!");
            Debug.Log("   --- -- - GRE844IUVBA983>> Message: " + eventSuccess.Message);
            Debug.Log("   --- -- - GRE844IUVBA983>> Timestamp: " + eventSuccess.Timestamp);
            Debug.Log("   --- -- - GRE844IUVBA983>> Adid: " + eventSuccess.Adid);
            Debug.Log("   --- -- - GRE844IUVBA983>> Event token: " + eventSuccess.EventToken);
            Debug.Log("   --- -- - GRE844IUVBA983>> JSON response: " + eventSuccess.JsonResponse);
        }

        private void EventFailureCallback(AdjustEventFailure eventFailure)
        {
            Debug.Log("   --- -- - GRE844IUVBA983>> Event failure callback called!");
            Debug.Log("   --- -- - GRE844IUVBA983>> Message: " + eventFailure.Message);
            Debug.Log("   --- -- - GRE844IUVBA983>> Timestamp: " + eventFailure.Timestamp);
            Debug.Log("   --- -- - GRE844IUVBA983>> Adid: " + eventFailure.Adid);
            Debug.Log("   --- -- - GRE844IUVBA983>> Event token: " + eventFailure.EventToken);
            Debug.Log("   --- -- - GRE844IUVBA983>> Will retry: " + eventFailure.WillRetry);
            Debug.Log("   --- -- - GRE844IUVBA983>> JSON response: " + eventFailure.JsonResponse);
        }

        private void SessionSuccessCallback(AdjustSessionSuccess sessionSuccess)
        {
            Debug.Log("   --- -- - GRE844IUVBA983>> Session success callback called!");
            Debug.Log("   --- -- - GRE844IUVBA983>> Message: " + sessionSuccess.Message);
            Debug.Log("   --- -- - GRE844IUVBA983>> Timestamp: " + sessionSuccess.Timestamp);
            Debug.Log("   --- -- - GRE844IUVBA983>> Adid: " + sessionSuccess.Adid);
            Debug.Log("   --- -- - GRE844IUVBA983>> JSON response: " + sessionSuccess.JsonResponse);
        }

        private void SessionFailureCallback(AdjustSessionFailure sessionFailure)
        {
            Debug.Log("   --- -- - GRE844IUVBA983>> Session failure callback called!");
            Debug.Log("   --- -- - GRE844IUVBA983>> Message: " + sessionFailure.Message);
            Debug.Log("   --- -- - GRE844IUVBA983>> Timestamp: " + sessionFailure.Timestamp);
            Debug.Log("   --- -- - GRE844IUVBA983>> Adid: " + sessionFailure.Adid);
            Debug.Log("   --- -- - GRE844IUVBA983>> Will retry: " + sessionFailure.WillRetry);
            Debug.Log("   --- -- - GRE844IUVBA983>> JSON response: " + sessionFailure.JsonResponse);
        }
